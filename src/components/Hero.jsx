function Hero() {
  return (
    <div id="home" className="w-full lg:flex-1 bg-white border border-gray-200 rounded-3xl px-8 sm:px-12 py-12 sm:py-16 shadow-sm animate-card-in hover:-translate-y-2 hover:scale-[1.01] hover:border-accent/40 hover:shadow-2xl hover:shadow-orange-200/60 transition-all duration-500 ease-out">
